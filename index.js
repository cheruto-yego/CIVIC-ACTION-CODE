...
app.post('/signup', (req, res) => {
    ...
    connection.query(checkQuery, [email], (error, results) => {
        ...
        const insertQuery = 'INSERT INTO client_table (email, username, client_number, password) VALUES (?, ?, ?, ?)';
        connection.query(insertQuery, [email, username, client_number, password], (err, result) => {
            if (err) {
